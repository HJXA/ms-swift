...
export OUTPUT_DIR="/ruilab/jxhe/CoE_Monitor/ms-swift/output/test/SFT/PT_HJXA_Llama_5M"
# 确保目录存在
mkdir -p $OUTPUT_DIR
# datasets 1769,087
swift sft \
  --model /ruilab/jxhe/CoE_Monitor/checkpoints/coe_pt_init_models/Llama_104M \
  --template minimind \
  --report_to swanlab \
  --truncation_strategy right \
  --swanlab_token WODn49OiskSyv0qBnFZcL \
  --swanlab_project test_sft \
  --save_steps 100 \
  --max_steps 10000 \
