...
class HJXA_Qwen2Attention(LlamaAttention):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        query_states, key_states = apply_rotary_pos_emb(query_states, key_states, cos, sin) # 改为绝对编码就跳过这 + 在 embedding 阶段加入 position embedding # Sinusoidal Absolute Position Encoding
...
class HJXA_Qwen2DecoderLayer(LlamaDecoderLayer): 
    ...
    # Post-Norm: attention -> norm -> mlp -> norm : x = Norm(x + Sublayer(x))
